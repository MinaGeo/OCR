...
imageArray = ([img, imgGrey, imgBlur, imgCanny], [imageCountours, imageBiggestCountours, imageWarpColored, imgThresh]
...
imageStacked = utils.stackImages(imageArray, 0.3, labels)
